...
def get_students_problem_grades(request, csv=False):
    ...
    if not csv:
        ...
        header = [_(u"Name"), _(u"Username"), _(u"Grade"), _(u"Percent")]
        for student in students:
            percent = 0
            if student['max_grade'] > 0:
...
def post_metrics_data_csv(request):
    ...
    if data_type == 'subsection':
        header = [_(u"Section"), _(u"Subsection"), _(u"Opened by this number of students")]
        filename = sanitize_filename(_('subsections') + '_' + course_id)
    elif data_type == 'problem':
        header = [
            _(u"Section"), _(u"Problem"), _(u"Name"), _(u"Count of Students"),
            _(u"Percent of Students"), _(u"Score"),
        ]
